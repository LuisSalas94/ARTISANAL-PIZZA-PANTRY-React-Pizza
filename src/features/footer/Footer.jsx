          ...
          <div className="md:max-w-md lg:col-span-2">
            ...
            <form className="mt-4 flex flex-col md:flex-row">
              <input
                ...
                required
                type="text"
                className="focus:border-deep-purple-accent-400 focus:shadow-outline mb-3 h-12 w-full flex-grow appearance-none rounded border border-gray-300 bg-white px-4 shadow-sm transition duration-200 focus:outline-none md:mb-0 md:mr-2"
              />
              <button
                type="submit"
